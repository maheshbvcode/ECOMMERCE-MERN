...
import { AiFillFacebook, AiFillGithub, AiFillInstagram, AiFillLinkedin, AiFillYoutube, AiOutlineTwitter } from 'react-icons/ai'
    ...
    return (
        <div className='bg-[#000] text-white'>
            <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg-[#342ac8] py-7">
                <h1 className='lg:text-4xl text-3xl md:md-0 mb-6 lg:leading-normal font-semibold md:w-2/5'>
            ...
            >
                <span>© 2023 Mahesh Bv,Bengaluru. All rights reserved.</span>
